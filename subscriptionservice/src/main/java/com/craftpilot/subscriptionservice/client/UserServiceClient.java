package com.craftpilot.subscriptionservice.client;

import com.craftpilot.subscriptionservice.config.FeignClientConfig;
 ...
 */
@FeignClient(name = "userservice", path = "/users", configuration = FeignClientConfig.class)
