...
import com.craftpilot.subscriptionservice.model.common.CustomError;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles PubscriptionAlreadyExistException thrown when an attempt is made to create a subscription that already exists.
     *
     * @param ex The PubscriptionAlreadyExistException instance.
     * @return ResponseEntity with CustomError indicating subscription already exists.
     */
    @ExceptionHandler(PubscriptionAlreadyExistException.class)
    public ResponseEntity<CustomError> handlePubscriptionAlreadyExistException(final PubscriptionAlreadyExistException ex) {
    ...
    /**
     * Handles PubscriptionNotFoundException thrown when a requested subscription is not found.
     *
     * @param ex The PubscriptionNotFoundException instance.
     * @return ResponseEntity with CustomError indicating subscription not found.
     */
    @ExceptionHandler(PubscriptionNotFoundException.class)
    public ResponseEntity<CustomError> handlePubscriptionNotFoundException(final PubscriptionNotFoundException ex) {
        CustomError error = CustomError.builder()
                .httpStatus(HttpStatus.NOT_FOUND)
