...
@Configuration
@EnableReactiveMongoRepositories(basePackages = "com.craftpilot.imageservice.repository")
@Slf4j
public class MongoConfig extends AbstractReactiveMongoConfiguration {
    ...
    @Value("${spring.data.mongodb.connection-timeout:20000}")
    ...
    public MongoClient reactiveMongoClient() {
        log.info("Configuring MongoDB. Database: {}", databaseName);
        ...
        log.info("MongoDB configuration complete. Connection timeout: {}ms, socket timeout: {}ms", 
