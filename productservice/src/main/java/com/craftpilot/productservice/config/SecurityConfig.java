package com.craftpilot.productservice.config;

import com.craftpilot.productservice.filter.CustomBearerTokenAuthenticationFilter;
import com.craftpilot.productservice.security.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(customizer -> customizer
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**").permitAll()  // Swagger UI'ye izin ver
