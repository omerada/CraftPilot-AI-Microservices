...
public class FallbackController {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> userServiceFallback() {
        log.warn("User Service erişilemez durumda, fallback devreye girdi");
        Map<String, Object> response = new HashMap<>();
        response.put("status", "error");
        response.put("message", "Kullanıcı servisi şu anda erişilemez durumda. Lütfen daha sonra tekrar deneyin.");
