...
import com.craftpilot.userservice.exception.UserAlreadyExistException;
...
import com.craftpilot.userservice.model.user.mapper.RegisterRequestToUserEntityMapper;
import com.craftpilot.userservice.model.user.mapper.UserEntityToUserMapper;
import com.craftpilot.userservice.repository.UserRepository;
import com.craftpilot.userservice.service.RegisterService;
...
public class RegisterServiceImpl implements RegisterService {
    ...
    public User registerUser(RegisterRequest registerRequest) {
        ...
        userEntityToBeSave.setPasswordHash(passwordEncoder.encode(registerRequest.getPassword()));
