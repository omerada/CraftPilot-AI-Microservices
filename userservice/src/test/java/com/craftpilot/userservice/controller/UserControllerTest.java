...
import com.craftpilot.userservice.base.AbstractRestControllerTest;
import com.craftpilot.userservice.model.common.dto.response.CustomResponse;
...
import com.craftpilot.userservice.model.user.dto.request.RegisterRequest;
import com.craftpilot.userservice.model.user.dto.request.TokenInvalidateRequest;
import com.craftpilot.userservice.model.user.dto.request.TokenRefreshRequest;
import com.craftpilot.userservice.model.user.dto.response.TokenResponse;
import com.craftpilot.userservice.model.user.mapper.TokenToTokenResponseMapper;
import com.craftpilot.userservice.service.*;
...
class UserControllerTest extends AbstractRestControllerTest {
    ...
    void givenTokenRefreshRequest_WhenRefreshTokenForUser_ThenReturnTokenResponse() throws Exception {
        ...
        // Then
        mockMvc.perform(MockMvcRequestBuilders.post("/users/refresh-token")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void givenValidToken_whenValidateToken_thenReturnOk() throws Exception {
        ...
        // Then
        mockMvc.perform(MockMvcRequestBuilders.post("/users/validate-token")
    ...
    void givenValidToken_whenGetAuthentication_thenReturnAuthentication() throws Exception {
        ...
        // Then
        mockMvc.perform(MockMvcRequestBuilders.get("/users/authenticate")
                        .param("token", validToken))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isOk())
